        ...
        <div className="justify-between container px-6 h-16 flex items-center lg:items-stretch mx-auto">
          <div className="flex items-center">
            ...
            <ul className="pr-32 mt-3 xl:flex hidden items-center h-full">
              ...
              <li
                className="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-gry-800 mx-10 tracking-normal relative"
              ...
              <li
                ...
                onMouseOver={() => setDeliverables(true)}
              >
                {deliverables ? (
                  <ul className="bg-white shadow rounded py-1 w-32 left-0 mt-16 -ml-4 absolute  top-0">
                    <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal" onClick={() => router.push("/deliver/lading")}>
                      Landing Pages
                    </li>
